...
<template>
  <PqModal
    ...
    v-model="visible"
    :loading="loading"
    class="pq-file-picker-modal pq-modal-show-header-border pq-modal-show-footer-border"
    @open="handleOpen"
    @close="handleClose"
  >
    <PqSplitPanel
...
<script setup>
  ...
  import { useMessage, useMessageBox, findTree } from 'pq-admin-ent';
  import {
    EditOutlined,
    FolderOutlined,
    DeleteOutlined
