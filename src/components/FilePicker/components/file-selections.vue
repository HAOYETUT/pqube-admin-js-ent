<template>
  <div class="pq-file-picker-right">
    <div class="pq-file-picker-right-header">
      <div class="pq-file-picker-right-title">
      ...
      <ElLink
        type="danger"
        underline="never"
        class="pq-file-picker-right-clear"
...
<script setup>
  ...
  import { valueIsChanged } from 'pq-admin-ent/es/pq-basic-select/util';
