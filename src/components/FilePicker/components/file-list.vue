<template>
  <div class="pq-file-picker-main">
    <div class="pq-file-picker-body">
      <div class="pq-file-picker-toolbar">
        <ElUpload
          action=""
          :accept="accept"
          :showFileList="false"
        ...
        <div class="pq-file-picker-search">
          <ElInput
            :clearable="true"
      ...
      <template v-if="fileData.length">
        <div class="pq-file-picker-file-list" @scroll="handleFileListScroll">
          <PqFileList
            :boxChoose="true"
            :icons="localIcons"
...
<script setup>
  ...
  import {
    localIcons,
    localSmallIcons
  } from 'pq-admin-ent/es/pq-file-list/icons';
  import {
    SearchOutlined,
    MenuOutlined,
    AppstoreOutlined,
