  ...
  >
    <template #default="scope">
      <img
        ...
        class="pq-file-picker-tree-icon"
      />
      ...
      <ElIcon
        ...
        class="pq-file-picker-tree-more"
...
<script setup>
  import { ref } from 'vue';
  import { queryChild } from 'pq-admin-ent';
  ...
  const handleGroupContextmenu = (e, item) => {
    ...
    )?.querySelector?.('.pq-file-picker-tree-more');
