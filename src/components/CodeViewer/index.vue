...
<template>
  <div class="pq-code-viewer">
    <div class="pq-code-viewer-line-numbers">
...
<style lang="scss">
  ...
  .pq-code-viewer {
    ...
    overflow: auto;
    #{pqVarName('scrollbar', 'color')}: #5e5e5e;
    #{pqVarName('scrollbar', 'hover-color')}: #707070;
