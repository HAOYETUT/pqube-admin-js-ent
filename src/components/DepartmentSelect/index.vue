...
<template>
  <PqTreeSelect
    ...
    popperClass="pq-department-select-modal pq-modal-show-header-border pq-modal-show-footer-border"
...
<script setup>
  ...
  import { CityOutlined } from 'pq-admin-ent/es/icons';
  import { omit, eachTree, getValue } from 'pq-admin-ent/es/utils/common';
  import { useComponentEvents } from 'pq-admin-ent/es/utils/hook';
  import {
    treeSelectProps,
    treeSelectEmits
  } from 'pq-admin-ent/es/pq-tree-select/props';
...
<style lang="scss">
  ...
  /* 弹框 */
  .pq-department-select-modal {
    .pq-modal-body,
    .pq-drawer-body {
      padding: 0;
    }

    &.pq-tree-select-popper .pq-popover-body {
      padding: 0;

      & > .pq-department-select-wrapper {
        height: 100%;
      }
    }
  }
  ...
  /* 树 */
  .pq-department-select-body {
    flex: 1;
    display: flex;
    flex-direction: column;
    overflow: hidden;

    & > .pq-department-select-search {
      flex-shrink: 0;
      padding: 12px 16px;
      box-sizing: border-box;
    }

    & > .pq-department-tree-wrapper {
      flex: 1;
      overflow: hidden;
      box-sizing: border-box;

      & > .el-tree > .el-vl__wrapper {
        padding: 0 calc(#{pqVar('tree', 'item-radius')} * 4);
        #{pqVarName('tree', 'expand-margin')}: 0 2px 0
          calc(10px - #{pqVar('tree', 'item-radius')} * 2);
  ...
  .pq-department-select-right-header {
    flex-shrink: 0;
    display: flex;
    flex-direction: column;
    align-items: center;
  ...
  .pq-department-select-right-title {
    flex: 1;
    width: 100%;
    overflow: hidden;
    padding-right: 8px;
  ...
  .pq-department-select-right-clear {
    width: 100%;
    padding: 0 6px;
    margin-top: 6px;
  ...
  .pq-department-select-right-body {
    flex: 1;
    padding: 0 10px;
    box-sizing: border-box;
    user-select: none;
    ...
    &.is-sortable .pq-department-select-right-item {
      cursor: move;
    }
  }

  /* 选中列表项 */
  .pq-department-select-right-item {
    flex-shrink: 0;
    display: flex;
    align-items: center;
    padding: 4px;
  ...
  .pq-department-select-right-label {
    flex: 1;
    line-height: 16px;
    margin-left: 4px;
  ...
  .pq-department-select-right-icon {
    flex-shrink: 0;
    width: 24px;
    height: 24px;
    font-size: 16px;
  ...
  .pq-department-select-right-del {
    flex-shrink: 0;
    width: 18px;
    height: 18px;
    font-size: 12px;
  ...
  @media screen and (max-width: 767.99px) {
    .pq-department-select-body > .pq-pro-table {
      padding-bottom: 8px;
    }
