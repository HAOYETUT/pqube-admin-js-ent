...
import { defaultComponentData as componentData } from 'pq-admin-ent/es/pq-pro-form-builder/util';
import {
  codeTips,
  vIfCodeTips
} from 'pq-admin-ent/es/pq-pro-form-builder/components/component-data';
    ...
    configForm: [
      {
        ...
        type: 'label',
        props: { class: 'pq-pro-form-builder-props-group-label' }
      },
      {
        label: '组件类型',
        prop: 'type',
      ...
      },
      {
        ...
        props: {
          ...
          class: 'pq-pro-form-builder-props-options-check-card'
        }
      },
      {
        label: '组件属性',
    ...
    configForm: [
      ...
      },
      {
        ...
        props: {
          ...
          class: 'pq-pro-form-builder-props-options-check-card is-loose'
        }
      },
      {
        label: '值类型',
