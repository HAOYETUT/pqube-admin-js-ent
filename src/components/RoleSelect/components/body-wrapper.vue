<template>
  <div class="pq-role-select-wrapper">
    <div class="pq-role-select-body">
      <!-- 搜索表单 -->
      <ElForm
        labelWidth="78px"
        class="pq-role-select-search"
    ...
    <!-- 已选列表 -->
    <div class="pq-role-select-right">
      <div class="pq-role-select-right-header">
        <div class="pq-role-select-right-title">
        ...
        <ElLink
          type="danger"
          underline="never"
          class="pq-role-select-right-clear"
      ...
      <VueDraggable
        ...
        :delay="150"
        :disabled="!multiple"
        class="pq-role-select-right-body"
        :class="{ 'is-sortable': multiple }"
        :modelValue="selectedItems"
        @update:modelValue="updateModelValue"
      >
        <template #item="{ element: item }">
          <div class="pq-role-select-right-item">
            <ElIcon class="pq-role-select-right-icon">
              <component v-if="itemIcon" :is="itemIcon" />
              <IdcardOutlined v-else />
            </ElIcon>
            <div class="pq-role-select-right-label">{{ item.label }}</div>
            <ElIcon
              class="pq-role-select-right-del"
...
<script setup>
  ...
  import { CloseOutlined, IdcardOutlined } from 'pq-admin-ent/es/icons';
