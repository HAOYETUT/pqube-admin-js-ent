...
<template>
  <PqTableSelect
    ...
    popperClass="pq-role-select-modal pq-modal-show-header-border pq-modal-show-footer-border"
...
<style lang="scss">
  ...
  .pq-role-select-right-body {
    ...
    &.is-sortable .pq-role-select-right-item {
      cursor: move;
    }
  }

  /* 选中列表项 */
  .pq-role-select-right-item {
    flex-shrink: 0;
    display: flex;
    align-items: center;
    padding: 4px;
  ...
  @media screen and (max-width: 767.99px) {
    .pq-role-select-body > .pq-pro-table {
      padding-bottom: 8px;
    }
