...
export function usePageTab() {
  ...
  const removePageTab = (option, tip) => {
    tabStore
      ...
      .catch(() => {
        if (tip !== false) {
          PqMessage.error({ message: '当前页签不可关闭', plain: true });
        }
      });
  };
  ...
  const removeLeftPageTab = (option, tip) => {
    tabStore
      ...
      .catch(() => {
        if (tip !== false) {
          PqMessage.error({ message: '左侧没有可关闭的页签', plain: true });
        }
      });
  };
  ...
  const removeRightPageTab = (option, tip) => {
    tabStore
      ...
      .catch(() => {
        if (tip !== false) {
          PqMessage.error({ message: '右侧没有可关闭的页签', plain: true });
        }
      });
  };
  ...
  const removeOtherPageTab = (option, tip) => {
    tabStore
      ...
      .catch(() => {
        if (tip !== false) {
          PqMessage.error({ message: '没有可关闭的页签', plain: true });
        }
      });
  };
