...
export const PREDEFINED_LAYOUTS = [
  ...
  },
  {
    ...
    config: {
      ...
      headerCustomStyle: null,
      tabsCustomStyle: {
        '--el-bg-color': 'var(--pq-layout-bg)'
      },
      contentCustomStyle: null,
      layoutCustomStyle: {
        '--pq-header-height': '46px',
        '--pq-header-primary-bg': 'var(--el-color-primary)'
      },
      layoutCustomClass: null
    },
  ...
  },
  {
    ...
    config: {
      ...
      contentCustomStyle: null,
      layoutCustomStyle: {
        '--pq-sidebox-width': '96px',
        '--pq-sidebar-collapse-width': '70px',
        '--pq-header-height': '46px'
      },
...
export const PREDEFINED_SKINS = [
  {
    ...
    color: '#2f54eb',
    cover: 'CoverSimple',
    themeClass: 'pq-theme-simple',
    darkConfig: {
      color: '#2f54eb',
      cover: 'CoverSimpleDark',
      themeClass: 'pq-theme-simple-dark'
    },
  ...
  },
  {
    ...
    color: '#5f80c7',
    cover: 'CoverModernDefault',
    themeClass: 'pq-theme-modern',
    darkConfig: {
      color: '#5f80c7',
      cover: 'CoverModernDefault',
      themeClass: 'pq-theme-modern-dark'
    },
