...
import { changeColor, changeSkin } from 'pq-admin-ent/es/utils/theme-util';
...
export function changeTheme(color, dark, skinCfg) {
  ...
  $html.className.split(' ').forEach((className) => {
    if (className.startsWith('pq-theme-')) {
