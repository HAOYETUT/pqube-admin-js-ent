  ...
  <pq-page :multi-card="false">
        ...
        >
          <div style="padding: 24px">
            <div style="display: flex; align-items: center">
              ...
              <pq-text size="md" style="flex: 1; padding-left: 12px">
                {{ item.title }}
              </pq-text>
            </div>
            <pq-ellipsis style="margin-top: 16px">
              网址: {{ item.url }}
            </pq-ellipsis>
            <pq-ellipsis style="margin-top: 6px">
              最后更新时间: {{ item.time }}
            </pq-ellipsis>
          </div>
          <el-divider style="margin: 0; opacity: 0.48" />
          <div class="list-item-footer">
            <pq-tooltip placement="top" content="分享" :offset="-8">
              <pq-text
                :icon="Share"
                type="secondary"
            ...
            <pq-tooltip placement="top" content="设置" :offset="-8">
              <pq-text
                :icon="Tools"
                type="secondary"
                class="list-item-tool"
            ...
            <el-divider direction="vertical" style="margin: 0; opacity: 0.8" />
            <pq-tooltip placement="top" content="删除" :offset="-8">
              <pq-text
                :icon="DeleteFilled"
                type="secondary"
                class="list-item-tool"
    ...
    <pq-pagination
      ...
      :style="{
        ...
        '--pq-pagination-hover-bg': 'transparent',
        '--pq-pagination-hover-color': 'var(--el-color-primary)'
      }"
    />
  </pq-page>
</template>
