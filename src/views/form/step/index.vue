<template>
  <div>
    <pq-card style="border-radius: 0">
      <pq-text type="heading" size="lg">分步表单</pq-text>
      <pq-text type="placeholder" style="margin-top: 6px">
        将一个冗长或用户不熟悉的表单任务分成多个步骤，指导用户完成。
      </pq-text>
    </pq-card>
    <pq-page>
      <pq-card class="step-card">
        ...
        <template v-if="active === 0">
          ...
          <pq-alert :closable="false">
            <pq-text size="lg" style="margin-bottom: 12px">说明</pq-text>
            <pq-text size="md" style="margin-bottom: 8px">
              转账到支付宝
            </pq-text>
            <pq-text style="margin-bottom: 12px">
              如果需要，这里可以放一些关于产品的常见问题说明。如果需要，
              这里可以放一些关于产品的常见问题说明。如果需要，这里可以放一些关于产品的常见问题说明。
            </pq-text>
            <pq-text size="md" style="margin-bottom: 8px">转账到微信</pq-text>
            <pq-text style="margin-bottom: 8px">
              如果需要，这里可以放一些关于产品的常见问题说明。如果需要，
              这里可以放一些关于产品的常见问题说明。如果需要，这里可以放一些关于产品的常见问题说明。
            </pq-text>
          </pq-alert>
