<template>
  <pq-card header="多列菜单" :body-style="{ padding: '12px' }">
    <frame-card>
      <pq-admin-layout
        :height="600"
        ...
        :mobile="mobile"
        :style="{ '--pq-sidebar-collapse-width': '74px' }"
      ...
      >
        ...
        <div :style="{ flex: 'auto', padding: '12px 12px 0 12px' }">
          ...
          <el-row :gutter="12">
            <el-col :span="12">
              <pq-card style="height: 120px; margin-bottom: 12px" />
            </el-col>
            <el-col :span="12">
              <pq-card style="height: 120px; margin-bottom: 12px" />
            </el-col>
            <el-col :span="16">
              <pq-card style="height: 332px; margin-bottom: 12px" />
            </el-col>
            <el-col :span="8">
              <div>
                <pq-card style="height: 160px; margin-bottom: 12px" />
                <pq-card style="height: 160px; margin-bottom: 12px" />
              </div>
            </el-col>
            <el-col :span="8">
...
<style lang="scss" scoped>
  .demo-menu-wrapper :deep(.pq-admin-sidebar) {
    background: #121319;
    --el-color-primary: #328dfc;

    .el-menu {
      padding: 0 8px;
      --pq-menu-dark-color: #fff;
