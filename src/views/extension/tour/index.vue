<template>
  <pq-page>
    <pq-card header="基本用法">
      ...
      <pq-tour v-model="current1" :steps="steps1" />
    </pq-card>
    <pq-card header="不带遮罩层">
      <div>
      ...
      <pq-tour v-model="current2" :steps="steps2" :mask="false" />
    </pq-card>
    <pq-card header="混合弹窗等多种形式">
      <div>
      ...
      <pq-tour v-model="current3" :steps="steps3">
