  ...
  <pq-page>
        ...
        <template #item="{ item }">
          <div style="display: flex; padding: 18px 12px; height: 87px">
            ...
            <div style="flex: 1; overflow: hidden; padding-left: 12px">
              <pq-text size="md">{{ item?.title }}</pq-text>
              <pq-ellipsis size="sm" type="secondary" :max-line="3">
                {{ item?.content }}
              </pq-ellipsis>
            </div>
          </div>
    ...
    >
      <div style="padding: 20px">
        <pq-check-card v-model="checked2" :items="items" :row="{ gutter: 12 }">
          <template #item="{ item }">
            <div style="display: flex; padding: 18px 12px; height: 87px">
              <el-avatar :size="46" shape="square" :src="item?.avatar" />
              <div style="flex: 1; overflow: hidden; padding-left: 12px">
...
<style lang="scss">
  ...
  .pq-check-card-group > .pq-check-card:nth-child(2) .demo-card-pay-img {
    &::before {
      width: 32px;
  ...
  .pq-check-card-group > .pq-check-card:last-child .demo-card-pay-img {
    &::before {
      width: 38px;
