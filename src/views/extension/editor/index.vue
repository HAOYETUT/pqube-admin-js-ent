<template>
  <pq-page :multi-card="true">
    <pq-card>
      <!-- 按钮 -->
      <div style="margin-bottom: 16px">
        <el-button type="primary" class="pq-btn-icon" @click="setContent">
          修改内容
        </el-button>
        <el-button type="primary" class="pq-btn-icon" @click="showHtml">
          获取内容
        </el-button>
        <el-button
          class="pq-btn-icon"
...
<script setup>
  ...
  const setContent = () => {
    content.value = [
      ...
      '   <div style="font-size: 28px;margin-bottom: 16px;">PqAdminPlus后台管理模板</div>',
