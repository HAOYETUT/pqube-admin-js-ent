...
<template>
  <el-row :gutter="16">
    <el-col :md="6" :sm="12" :xs="24">
      <pq-card class="statistics-card">
        <pq-text type="placeholder" class="statistics-header">
          <div class="statistics-header-text">总销售额</div>
          <pq-tooltip content="指标说明" placement="top" :offset="6">
            <el-icon class="statistics-header-tip">
              <QuestionCircleOutlined />
            </el-icon>
          </pq-tooltip>
        </pq-text>
        <pq-text size="xxl" class="statistics-value">¥ 126,560</pq-text>
        <div class="statistics-body">
          <div class="statistics-trend-text">
            <div>周同比12%</div>
            <pq-text type="danger" :icon="CaretUpFilled" />
          </div>
          <div class="statistics-trend-text">
            <div>日同比11%</div>
            <pq-text type="success" :icon="CaretDownFilled" />
          </div>
        </div>
        <el-divider />
        <div>日销售额 ￥12,423</div>
    ...
    <el-col :md="6" :sm="12" :xs="24">
      <pq-card class="statistics-card">
        ...
        <pq-text size="xxl" class="statistics-value">8,846</pq-text>
        <v-chart
          ref="visitChartRef"
    ...
    <el-col :md="6" :sm="12" :xs="24">
      <pq-card class="statistics-card">
        ...
        <pq-text size="xxl" class="statistics-value">6,560</pq-text>
        <v-chart
          ref="payNumChartRef"
    ...
    <el-col :md="6" :sm="12" :xs="24">
      <pq-card class="statistics-card">
        ...
        <pq-text size="xxl" class="statistics-value">78%</pq-text>
        <div class="statistics-body">
          <el-progress
