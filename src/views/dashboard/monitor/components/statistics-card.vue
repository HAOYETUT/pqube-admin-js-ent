...
<template>
  <el-row :gutter="16">
    <el-col :md="6" :sm="12" :xs="24">
      <pq-card class="monitor-count">
        <el-tag size="large" :disable-transitions="true">
          <el-icon>
            <UserFilled />
          </el-icon>
        </el-tag>
        <pq-text size="xxl" class="monitor-count-value">21.2 k</pq-text>
        <pq-text type="placeholder" class="monitor-count-text">
          总访问人数
        </pq-text>
        <pq-avatar-group :data="visitUsers" size="small" :max-count="4" />
      </pq-card>
    </el-col>
    <el-col :md="6" :sm="12" :xs="24">
      <pq-card class="monitor-count">
        ...
        <pq-text size="xxl" class="monitor-count-value">1.6 k</pq-text>
        <pq-text type="placeholder" class="monitor-count-text">
          点击量(近30天)
        </pq-text>
        <pq-text
        ...
        <pq-tooltip content="指标说明" placement="top" :offset="3">
          <pq-text
    ...
    <el-col :md="6" :sm="12" :xs="24">
      <pq-card class="monitor-count">
        ...
        <pq-text size="xxl" class="monitor-count-value">826.0</pq-text>
        <pq-text type="placeholder" class="monitor-count-text">
          到达量(近30天)
        </pq-text>
        <pq-text
    ...
    <el-col :md="6" :sm="12" :xs="24">
      <pq-card class="monitor-count">
        ...
        <pq-text size="xxl" class="monitor-count-value">28.8 %</pq-text>
        <pq-text type="placeholder" class="monitor-count-text">
          转化率(近30天)
        </pq-text>
        <pq-text
