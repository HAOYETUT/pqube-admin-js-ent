<template>
  <pq-card header="在线人数">
    <div style="text-align: center">
      <pq-text type="placeholder">{{ currentTime }}</pq-text>
      <pq-text size="xxxl">
        <pq-count-up :end-val="onlineNum" />
      </pq-text>
      <pq-text type="placeholder" style="margin-bottom: 11px">
        在线总人数
      </pq-text>
      <pq-dot :text="updateTimeText" size="8px" />
    </div>
  </pq-card>
</template>
