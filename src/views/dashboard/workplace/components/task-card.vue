        ...
        >
          <template #item="{ element }">
            <tr>
              ...
              <td>
                <pq-ellipsis style="line-height: 20px">
              ...
              <td style="text-align: center; width: 80px">
                <pq-text v-if="element.status === 0" type="warning">
                  未开始
                </pq-text>
                <pq-text v-else-if="element.status === 1" type="success">
                  进行中
                </pq-text>
                <pq-text v-else-if="element.status === 2" type="info" deleted>
                  已完成
                </pq-text>
              </td>
            </tr>
