<template>
  <pq-page hide-footer :multi-card="false" flex-table="auto">
    <pq-card :body-style="{ padding: 0 }" flex-table="auto">
      <pq-split-panel
        :space="0"
        :size="258"
        allow-collapse
        ...
        >
          <el-tree
            ...
            :style="{
              ...
              padding: '12px calc(var(--pq-tree-item-radius) * 3)'
            }"
...
<script setup>
  ...
  import { PqMessage, toTree, useModal } from 'pq-admin-ent';
  import {
    CityOutlined,
    SearchOutlined,
    DeleteOutlined,
