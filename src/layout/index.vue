<template>
  ...
  <el-icon
    ...
    class="pq-layout-fullscreen-icon"
...
<script setup>
  ...
  import { LayoutTool, TabDropdown, checkFullscreen } from 'pq-admin-ent';
  import {
    MenuFoldOutlined,
    MenuUnfoldOutlined,
    ReloadOutlined,
  ...
  const tabDropdownMenuStyle = {
    '--pq-dropdown-item-padding': '0 18px',
    '--pq-dropdown-item-height': '30px',
    '--pq-dropdown-item-margin': '0px',
    '--pq-dropdown-divider-margin': '3px 0',
    '--pq-dropdown-icon-margin': '0 12px 0 -4px',
    '--pq-dropdown-icon-size': '15px'
  };
