<template>
  <!-- 侧栏风格 -->
  <div class="pq-setting-theme">
    <div class="pq-setting-theme-item">
      <div
        class="pq-setting-theme-item-cover pq-setting-side-light"
    ...
    <div class="pq-setting-theme-item">
      <div
        class="pq-setting-theme-item-cover pq-setting-side-dark"
  ...
  <div class="pq-setting-theme">
    <div class="pq-setting-theme-item">
      <div
        class="pq-setting-theme-item-cover pq-setting-head-light"
    ...
    <div class="pq-setting-theme-item">
      <div
        class="pq-setting-theme-item-cover pq-setting-head-dark"
    ...
    <div class="pq-setting-theme-item">
      <div
        class="pq-setting-theme-item-cover pq-setting-head-primary"
  ...
  <ElDivider />
  <!-- 导航布局 -->
  <PqText type="placeholder" class="pq-setting-title">
    {{ t('layout.setting.layout') }}
  </PqText>
  <div class="pq-setting-theme hidden-xs-only">
    <div class="pq-setting-theme-item">
      <div
        class="pq-setting-theme-item-cover pq-setting-side-dark pq-setting-layout-side"
    ...
    <div class="pq-setting-theme-item">
      <div
        class="pq-setting-theme-item-cover pq-setting-head-dark pq-setting-layout-top"
        @click="updateValue('layout', 'top')"
      >
        <PqText v-if="layout === 'top'" type="primary" :icon="CheckOutlined" />
      </div>
      <div>{{ t('layout.setting.layoutStyles.top') }}</div>
    </div>
    <div class="pq-setting-theme-item">
      <div
        class="pq-setting-theme-item-cover pq-setting-layout-mix"
        @click="updateValue('layout', 'mix')"
      >
        <PqText v-if="layout === 'mix'" type="primary" :icon="CheckOutlined" />
      </div>
  ...
  <ElDivider />
  <!-- 重置 -->
  <div class="pq-setting-footer">
    <ElButton size="small" class="pq-fluid" @click="resetSetting">
